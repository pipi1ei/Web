  ...
  <div class="content">
    <div class="table-container">
      <el-table height="100%" :data="tableData" stripe border style="width: 100%" align="center">
        ...
        <el-table-column prop="upgradeCount" label="预升级数量" align="center" width="100"></el-table-column>
        ...
        <el-table-column fixed="right" label="操作" align="center" width="220">
          <template slot-scope="scope">
            ...
            <!-- <el-button size="mini" type="primary" @click="handDetailsClick(scope.row)">详情</el-button> -->
            <el-button
              size="mini"
              type="primary"
...
export default {
  ...
  methods: {
    ...
    canOffline(tableItem) {
      return tableItem.status === "0";
    },
    // 上线
    ...
    // 展示详情
    handDetailsClick(tableItem) {
      this.$emit("handDetailsClick", tableItem);
    },
    // 每页展示数量改变
